...
rule Ransomware_Generic {
    ...
    strings:
        ...
        $encrypted_extension5 = /malicious_.{3,10}_string/
    condition:
...
rule Type_Malware_rev_shell : Antivirus_Detection{
    meta:
        description = "Contains references to security software"
    strings:
        $a0 = "AAWTray.exe" nocase wide ascii 
        $a = "@echo" nocase wide ascii
        $b = "del" nocase wide ascii
...
rule Metasploit_Backdoor{
    meta:
        description = "Detect the Metasploit Generated Malicious files"
        Author = "HAvox"
    strings:
        $a = "-,<tr %s><th %s colspan=4>Connnection Times (ms)</th></tr>"
